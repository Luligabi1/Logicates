...
public class ScreenHandlingRegistry {
    ...
    public static final ScreenHandlerType<KeypadLogicateScreenHandler> KEYPAD_LOGICATE_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(Logicates.id("keypad_logicate"), KeypadLogicateScreenHandler::new);
